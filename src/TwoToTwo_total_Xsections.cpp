...
double TwoToTwo_Tot_Xsections::total_xsection_C14(double s) {
  ...
  sigma =
      (pow(Const, 2) * pow(g_POR, 4) *
       ((-0.125 * pow(momega, 8) - 0.125 * pow(mpion, 8) +
         0.25 * pow(mpion, 6) * pow(mrho, 2) -
         0.125 * pow(mpion, 4) * pow(mrho, 4) +
         pow(momega, 6) *
             (0.5 * pow(mpion, 2) + 0.25 * pow(mrho, 2) - 0.25 * s) +
         pow(momega, 2) * pow(mpion, 2) *
             (0.25 * pow(mrho, 4) + 0.25 * pow(mpion, 2) * s -
              0.25 * pow(mrho, 2) * s) +
         pow(momega, 4) * (-0.5 * pow(mpion, 4) - 0.125 * pow(mrho, 4) +
                           pow(mpion, 2) * (-0.5 * pow(mrho, 2) + 0.5 * s) +
                           0.25 * pow(mrho, 2) * s - 0.25 * pow(s, 2))) /
            (1. * pow(momega, 2) - 1. * tmin) -
        0.125 *
            (3. * pow(momega, 4) + 4. * pow(mpion, 4) + pow(mrho, 4) +
             pow(mpion, 2) * (4. * pow(mrho, 2) - 4. * s) -
             2. * pow(mrho, 2) * s + 2. * pow(s, 2) +
             pow(momega, 2) *
                 (-8. * pow(mpion, 2) - 4. * pow(mrho, 2) + 4. * s)) *
            tmin -
        0.125 * (pow(momega, 2) - 2. * pow(mpion, 2) - 1. * pow(mrho, 2) + s) *
            pow(tmin, 2) -
        ...
        0.25 *
            (2. * pow(momega, 6) +
             pow(momega, 4) *
                 (-6. * pow(mpion, 2) - 3. * pow(mrho, 2) + 3. * s) +
             pow(mpion, 2) * (-1. * pow(mrho, 4) - 1. * pow(mpion, 2) * s +
                              pow(mrho, 2) * s) +
             pow(momega, 2) * (4. * pow(mpion, 4) + pow(mrho, 4) +
                               pow(mpion, 2) * (4. * pow(mrho, 2) - 4. * s) -
                               2. * pow(mrho, 2) * s + 2. * pow(s, 2))) *
            log(fabs(-1. * pow(momega, 2) + tmin)) -
        (HeavisideTheta(-momega + sqrt(s)) *
         (tmin * (0.125 * pow(mpion, 8) - 0.25 * pow(mpion, 6) * pow(mrho, 2) +
                  pow(mpion, 4) *
                      (0.125 * pow(mrho, 4) +
                       pow(momega, 2) * (0.25 * pow(mrho, 2) - 0.5 * s) -
                       0.25 * pow(mrho, 2) * s + s * (1. * s - 0.125 * tmin)) +
                  pow(mpion, 2) * s *
                      (1. * pow(momega, 4) - 0.25 * pow(mrho, 4) +
                       s * (-1.5 * s - 0.75 * tmin) +
                       pow(mrho, 2) * (1.5 * s + 0.125 * tmin) +
                       pow(momega, 2) *
                           (-1.0000000000000002 * pow(mrho, 2) + 0.5 * tmin)) +
                  s * (-0.25 * pow(momega, 6) +
                       pow(momega, 4) *
                           (0.25 * pow(mrho, 2) - 0.5 * s - 0.125 * tmin) +
                       pow(momega, 2) * (0.5 * pow(s, 2) - 0.25 * s * tmin +
                                         (0.125 * pow(mrho, 2) -
                                          0.08333333333333333 * tmin) *
                                             tmin) +
                       s * (0.125 * pow(mrho, 4) + 0.375 * pow(s, 2) +
                            pow(mrho, 2) * (-0.5 * s - 0.25 * tmin) +
                            0.5 * s * tmin +
                            0.16666666666666666 * pow(tmin, 2)))) +
          (-0.25 * pow(momega, 8) * s +
           pow(momega, 6) *
               (1. * pow(mpion, 2) + 0.25 * pow(mrho, 2) - 0.5 * s) * s +
           pow(mpion, 4) * s *
               (0.25 * pow(mpion, 4) - 0.25 * pow(mrho, 2) * s) +
           pow(momega, 4) *
               (pow(mpion, 4) * (0.25 * pow(mrho, 2) - 0.5 * s) -
                1.0000000000000002 * pow(mpion, 2) * pow(mrho, 2) * s +
                0.5 * pow(s, 3)) +
           pow(momega, 2) *
               (-0.25 * pow(mpion, 8) + 0.5 * pow(mpion, 4) * pow(s, 2) +
                pow(mpion, 2) * (1. * pow(mrho, 2) - 1. * s) * pow(s, 2) +
                (-0.25 * pow(mrho, 2) + 0.25 * s) * pow(s, 3))) *
              log(fabs(-1. * pow(momega, 2) + tmin)))) /
        ...
        0.25 *
            (2. * pow(momega, 6) +
             ...
             pow(momega, 2) * (4. * pow(mpion, 4) + pow(mrho, 4) +
                               pow(mpion, 2) * (4. * pow(mrho, 2) - 4. * s) -
                               2. * pow(mrho, 2) * s + 2. * pow(s, 2))) *
            log(fabs(-1. * pow(momega, 2) + tmax)) +
        (HeavisideTheta(-momega + sqrt(s)) *
         (tmax * (0.125 * pow(mpion, 8) - 0.25 * pow(mpion, 6) * pow(mrho, 2) +
                  pow(mpion, 4) *
                      (0.125 * pow(mrho, 4) +
                       pow(momega, 2) * (0.25 * pow(mrho, 2) - 0.5 * s) -
                       0.25 * pow(mrho, 2) * s + s * (1. * s - 0.125 * tmax)) +
                  pow(mpion, 2) * s *
                      (1. * pow(momega, 4) - 0.25 * pow(mrho, 4) +
                       s * (-1.5 * s - 0.75 * tmax) +
                       pow(mrho, 2) * (1.5 * s + 0.125 * tmax) +
                       pow(momega, 2) *
                           (-1.0000000000000002 * pow(mrho, 2) + 0.5 * tmax)) +
                  s * (-0.25 * pow(momega, 6) +
                       pow(momega, 4) *
                           (0.25 * pow(mrho, 2) - 0.5 * s - 0.125 * tmax) +
                       pow(momega, 2) * (0.5 * pow(s, 2) - 0.25 * s * tmax +
                                         (0.125 * pow(mrho, 2) -
                                          0.08333333333333333 * tmax) *
                                             tmax) +
                       s * (0.125 * pow(mrho, 4) + 0.375 * pow(s, 2) +
                            pow(mrho, 2) * (-0.5 * s - 0.25 * tmax) +
                            0.5 * s * tmax +
...
double TwoToTwo_Tot_Xsections::total_xsection_C15(double s) {
  ...
  sigma = HeavisideTheta(-momega + sqrt(s)) *
